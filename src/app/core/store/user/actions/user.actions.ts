...
export const UserActions = createActionGroup({
    ...
    events: {
        ...
        'Add Role To User': props<{ userId: string, roleId: string }>(),
        'Add Role To User Success': props<{ user: User }>(),
        'Add Role To User Failure': props<{ error: any }>(),

        'Remove Role From User': props<{ userId: string, roleId: string }>(),
        ...
        'Add Permission To User': props<{ userId: string, permissionId: string }>(),
        'Add Permission To User Success': props<{ user: User }>(),
        'Add Permission To User Failure': props<{ error: any }>(),

        'Remove Permission From User': props<{ userId: string, permissionId: string }>(),
