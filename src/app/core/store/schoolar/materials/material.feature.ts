...
import { materialInitialState, materialsAdapter } from './material.state';
...
export const materialFeature = createFeature({
    ...
    reducer: createReducer(
        ...
        on(MaterialActions.loadMaterialsByEntity, (state) => ({
            ...state,
        ...
        on(MaterialActions.loadMaterialsByEntityFailure, (state, { byEntityError }) => ({
            ...state,
            loadingByEntity: false,
            byEntityError
        })),
