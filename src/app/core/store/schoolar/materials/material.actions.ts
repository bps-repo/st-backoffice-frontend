...
export const MaterialActions = createActionGroup({
  ...
  events: {
    ...
    'Load Materials By Type': props<{ type: string }>(),
    'Load Materials By Type Success': props<{ type: string, materials: Material[] }>(),
    'Load Materials By Type Failure': props<{ error: string }>(),
